...
export default function HodLayout({ children }: { children: React.ReactNode }) {
  ...
  const hodNav = [
    { id: 'dashboard', label: 'Department Analytics', href: '/hod/dashboard' },
  ];

  const currentNav = hodNav.find((i) => pathname === i.href);
  const headerTitle = currentNav ? currentNav.label : 'HOD Dashboard';
